...
const en: Dict = {
  ...
  'records.lead': 'Every record the Department of War has released under PURSUE, indexed with the link to the material at the publisher. This is the source layer, not the case base. A document listed here has not been read, scored or summarised by us: its presence proves that the document exists, and nothing beyond that.',
  ...
  'records.harvested': 'Index read on {d}',
  ...
  'rec.aid': 'Found through',
  'rec.aidNote': 'A finding aid, not a citation. An index is where you find a document, never where you cite it.',
  ...
  'home.recLead': '{n} records the Department of War has released under PURSUE, each with the link to the material at the publisher. Not one of them is a case yet. The bottleneck in this subject was never the number of sightings: it is that almost nobody reads the paperwork.',
...
const pl: Dict = {
  ...
  'records.lead': 'Wszystkie rekordy, które Departament Wojny udostępnił w ramach PURSUE, z odnośnikiem do materiału u wydawcy. To warstwa źródłowa, nie baza spraw. Dokumentu z tej listy nie przeczytaliśmy, nie oceniliśmy i nie streściliśmy: jego obecność dowodzi, że dokument istnieje, i niczego ponad to.',
  ...
  'records.harvested': 'Indeks odczytany {d}',
  ...
  'rec.aid': 'Znalezione przez',
  'rec.aidNote': 'Pomoc archiwalna, nie cytowanie. Indeks jest miejscem, w którym dokument się znajduje, nigdy miejscem, z którego się go cytuje.',
  ...
  'home.recLead': '{n} rekordów, które Departament Wojny udostępnił w ramach PURSUE, każdy z odnośnikiem do materiału u wydawcy. Żaden z nich nie jest jeszcze sprawą. Wąskim gardłem w tym temacie nigdy nie była liczba obserwacji, tylko to, że papierów prawie nikt nie czyta.',
