...
const en: Dict = {
  ...
  'home.lead': 'The UAP problem is not a shortage of cases. It is a shortage of data. This database separates what a document recorded from what was added later — case by case, claim by claim.',
  ...
  'map.world': 'World',
  'map.core': '◆ pulsing = evidential core',
...
const pl: Dict = {
  ...
  'home.coreKicker': 'Rdzeń dowodowy',
  ...
  'map.world': 'Świat',
  'map.core': '◆ pulsujące = rdzeń dowodowy',
