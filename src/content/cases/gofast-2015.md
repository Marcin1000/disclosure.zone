...
evidence: ["ir", "film"]
scores: { S: 4, R: 1, O: 4, P: 0, M: 2, T: 5, X: 1, D: 5 }
...
sources:
  ...
  - tier: "T2"
    label: "Analiza niezależnego zespołu NASA ds. UAP (2023)"
---

## Najlepszy dowód na to, że oko myli się co do prędkości

GOFAST wygląda dokładnie tak, jak wygląda obiekt lecący centymetry nad wodą z zawrotną prędkością.
Nie jest nim.

Dane potrzebne do przeliczenia są **na samym nagraniu**: kąt patrzenia i zasięg do celu widoczne
