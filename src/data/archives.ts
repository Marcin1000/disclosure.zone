...
export const archives: Archive[] = [
  ...
  },
  {
    ...
    years: '2008–2010', status: 'closed', publicDb: false,
    ...
    note: {
      en: 'A contract, not an investigating office. The DIA’s Acquisition Support Division set the objectives on 18 July 2008: “to understand the physics and engineering” of breakthrough aerospace applications “as they apply to the foreign threat out to the far term, i.e., from now through the year 2050”, in twelve technical areas from lift and propulsion to “spatial/temporal translation” and “human effects”, with work classified up to TS/SCI. The solicitation went out on 1 September 2008 as an unrestricted request for proposals with offers due on 10 September; on 22 September 2008 the award went to Bigelow Aerospace Advanced Space Studies of Las Vegas, firm fixed price, a base year of $10,000,000 and four option years anticipated. Modification P00001 (September 2009) exercised the first option “subject to availability of funds” at a price of $25,000,000, and contradicts itself on dates: its text moves the option year to 1 October 2009 – 30 September 2010, its own schedule gives 22 September 2009 – 21 September 2010. P00002 (February 2010) funded the option at $11,948,810 and called for the impacts and technical risks of the “reduced funding”; P00003 changed the contracting officer’s representative; P00005 extended the period to 21 December 2010 with no new money. Clause 52.227-17 gives the government unlimited rights in all data produced under the contract and bars the contractor from publishing any of it without the contracting officer’s written permission. Read the published order with care: it is a conformed copy, not the 2008 document. It already carries the total of $21,948,810, the option-year lines as rewritten by P00002 and a form footer dated 2012. Not released: the BAASS proposal the order incorporates by reference, the P00002 attachment on the impact of the cut, the text of P00004 (only its distribution sheet is out), and anything after 21 December 2010. None of the seven contract documents uses the words UFO, UAP, unidentified, anomalous or paranormal.',
      pl: 'Umowa, a nie urząd prowadzący badania. Wydział wsparcia zamówień DIA określił cele 18 lipca 2008 r.: „to understand the physics and engineering”, czyli zrozumieć fizykę i inżynierię przełomowych zastosowań lotniczo-kosmicznych „as they apply to the foreign threat out to the far term, i.e., from now through the year 2050”, w odniesieniu do zagrożenia zagranicznego do 2050 r., w dwunastu obszarach technicznych od siły nośnej i napędu po „spatial/temporal translation” i „human effects”, z pracami utajnionymi do poziomu TS/SCI. Zapytanie ofertowe wydano 1 września 2008 r. jako nieograniczone, z terminem składania ofert 10 września. 22 września 2008 r. umowę przyznano firmie Bigelow Aerospace Advanced Space Studies z Las Vegas: cena stała, rok bazowy za 10 000 000 $ i przewidywane cztery lata opcyjne. Modyfikacja P00001 (wrzesień 2009) uruchomiła pierwszą opcję „subject to availability of funds”, wycenioną na 25 000 000 $, i sama sobie przeczy co do dat: jej tekst przesuwa rok opcyjny na 1 października 2009 – 30 września 2010, a jej własny harmonogram podaje 22 września 2009 – 21 września 2010. P00002 (luty 2010) sfinansowała opcję kwotą 11 948 810 $ i poleciła wskazać skutki oraz ryzyka techniczne „reduced funding”, czyli zmniejszonego finansowania. P00003 zmieniła przedstawiciela oficera kontraktowego, a P00005 przedłużyła okres do 21 grudnia 2010 r. bez nowych pieniędzy. Klauzula 52.227-17 daje rządowi nieograniczone prawa do wszystkich danych wytworzonych w ramach umowy i zakazuje wykonawcy publikowania czegokolwiek z nich bez pisemnej zgody oficera kontraktowego. Opublikowane zamówienie trzeba czytać ostrożnie: to egzemplarz ujednolicony, a nie dokument z 2008 r. Zawiera już łączną kwotę 21 948 810 $, linie roku opcyjnego w brzmieniu nadanym przez P00002 i stopkę formularza z 2012 r. Nie opublikowano: oferty BAASS, którą zamówienie włącza przez odesłanie, załącznika P00002 o skutkach cięcia, treści P00004 (ujawniono tylko jej listę dystrybucyjną) ani niczego po 21 grudnia 2010 r. W żadnym z siedmiu dokumentów umowy nie pada słowo UFO, UAP, unidentified, anomalous ani paranormal.',
    },
    ref: 'pursue-d110',
  },
  {
